    ...
    <div className='grid w-full items-start gap-6 overflow-auto p-4 pt-0'>
        <fieldset className='relative grid gap-6 rounded-lg border p-4'>
            ...
            <Textarea
                ...
                placeholder='Extracted data from report will appear here. Get better recommendation by providing additional patient history and symptoms'
